...
class DatabaseHandler
{
  ...
  private static function GetHandler()
  {
    ...
    if (!isset(self::$_mHandler))
    {
      ...
      try
      {
        ...
        self::$_mHandler =
          new PDO(PDO_DSN, DB_USER, DB_PASS,
  ...
  public static function Ejecutar($sqlQuery, $params = null)
  {
  ...
  public static function ObtenerTodo($sqlQuery, $params = null,
  ...
  public static function ObtenerFila($sqlQuery, $params = null, $fetchStyle = PDO::FETCH_ASSOC)
  {
    // Initialize the return value to null
    $result = null;
  ...
  public static function ObtenerUna($sqlQuery, $params = null)
  {
    // Initialize the return value to null    
    $result = null;
  ...
  public static function getLastInsertId($sqlQuery, $params = null){
  	...
  	try {
  		...
  		$statement_handler = $dbh->prepare($sqlQuery);
  		try {
  			$dbh->beginTransaction();
  			$statement_handler->execute($params);
  			$statement_handler->commit();
  			$result =  $statement_handler->lastInsertId();
  		} catch(PDOException $e) {
  			$dbh->rollback();
  			trigger_error($e->getMessage(), E_USER_ERROR);
  		}

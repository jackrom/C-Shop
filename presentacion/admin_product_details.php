...
class AdminProductDetails
{
  ...
  public function __construct()
  {
    ...
    $this->mProductDisplayOptions = array ('Default',       // 0
		'En Catalogo',    // 1
		'En Departamento', // 2
		'En Ambos');   // 3
  ...
  public function init()
  {
    ...
    if (isset ($_POST['Upload']))
    {
      ...
      {
        echo "Imposible escribir en la carpeta product_images, revisar si esta tiene permisos definidos";
    ...
    if (isset ($_POST['UpdateProductInfo']))
    {
      ...
      if ($product_name == null)
        $this->mErrorMessage = 'El nombre del producto est&aacute; vac&iacute;o';

      if ($product_description == null)
        $this->mErrorMessage = 'La descripci&oacute;n del producto est&aacute; vac&iacute;o';

      if ($product_price == null || !is_numeric($product_price))
        $this->mErrorMessage = 'El precio del producto debe ser un n&uacute;mero!';

      if ($product_discounted_price == null ||
          !is_numeric($product_discounted_price))
        $this->mErrorMessage = 'El descuento del producto debe ser un n&uacute;mero!';

      if ($this->mErrorMessage == null)
        Catalog::UpdateProduct($this->_mProductId, $product_name, $product_summary, 

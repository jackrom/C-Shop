...
class Link
{
  ...
  public static function CheckRequest()
  {
    ...
    $requested_url = self::Build(str_replace('', '', $_SERVER['REQUEST_URI']));
  ...
  public static function ToSearchResults($searchString, $allWords,$page = 1)
  {
    ...
    $link = 'index.php?SearchResults&SearchString=';

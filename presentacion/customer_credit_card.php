...
class CustomerCreditCard
{
  ...
  public function __construct()
  {
    ...
    // Establecer destino de accion del formulario
    $this->mLinkToCreditCardDetails = Link::ToCreditCardDetails();

    // Configurar la pagina cancel
    ...
    // chequeamos si hemos enviado los datos
    if (isset ($_POST['sended']))
    {
      // Iniciamos/validamos las cosas
  ...
  public function init()
  {
    if (!isset ($_POST['sended']))
    {
      // Tomamos la informacion de la tarjeta de credito

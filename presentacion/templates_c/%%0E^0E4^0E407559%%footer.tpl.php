<?php /* Smarty version 2.6.26, created on 2013-07-14 14:46:39
	...
	<div class="widgets-footer">
		<div class="container clearfix">
			<div class="grid_3">
				...
				<div class="soporte">
						<ul>
							<li><i class="icon-wrench"></i><h3 class="soporte-title"><a href="soporte/">Soporte (Tickets)</a></h3></li>
				...
				<div class="recent-posts widget widget__footer">
					...
					<div class="widget-content">
						<ul class="recent-posts-list">
							...
							<li><a href="#">Aenean justo mauris, rhoncus nec tempor convallis</a></li>
							<li><a href="#">Nulla euismod ullamcorper tortor, sed aliquam</a></li>
						</ul>
					</div>
				</div>
				<!-- /Recent Post Widget -->
			...
			<div class="grid_12 mobile-nomargin">
				<div class="clearfix">
					<div class="copyright-primary">
						Juassi Studios &copy; 2013 <span class="separator">|</span><a href="#">Pol&iacute;tica de Privacidad</a>
					</div>
					<div class="copyright-secondary">
						Dise&ntilde;ado y desarrollado por <a href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
jcr">Juan Carlos Reyes</a>
					</div>
				</div>
			</div>
		</div>
...
js/jquery-1.9.1.min.js"></script>
	...
	<script src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
js/jquery-migrate-1.1.1.min.js"></script>
	<!-- Modernizr -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
js/modernizr.custom.14583.js"></script>
	<!-- easing plugin -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
...
js/jquery.fitvids.js"></script>
	<!-- Flickr -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
js/jflickrfeed.js"></script>
	<!-- Twitter -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
js/jquery.twitter.js"></script>
	<!-- Carousel -->
...
js/jquery.isotope.min.js"></script>
	<script src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
js/jquery.imagesloaded.min.js"></script>
	<!-- Magnific Popup -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>

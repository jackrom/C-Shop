...
<body>
  ...
  <!-- BEGIN PAGE TITLE -->
			...
			<div class="pagina_error">
				<h1>404</h1>
				<p><strong>Lo sentimos mucho, pero la p&aacute;gina que usted esperaba no existe en este sitio!!!</strong></p>
				<p>
		            Por favor visita nuestro
		            <a href="<?php echo Link::Build(''); ?>">catalogo</a>
		            si lo que estas buscando es algun tema o alguna aplicaci&oacute;n,</p>
		        <p> o envianos un <a href="<?php echo ADMIN_ERROR_MAIL; ?>">mail</a>
